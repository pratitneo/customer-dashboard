...
const NewCustInput = ({ label, inputType, nameType, inputPlaceHolder, inputErr, getInputValidation }: NewCustInpType) => {
    return (
        <div className={`${newCustInpCss['cust-dash__inputWrap']}`}>
